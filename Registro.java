...
public class Registro extends javax.swing.JFrame {
    ...
    public Registro() {
        ...
        setLocationRelativeTo(null);
          ...
          ImageIcon wallpaper = new ImageIcon("src/images/farma.jpg");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 192, -1, 50));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 300));
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        Connection cxn2 = Conexion.conectar();
                        PreparedStatement pst2 = cxn2.prepareStatement(
