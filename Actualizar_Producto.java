...
public class Actualizar_Producto extends javax.swing.JFrame {
   ...
   public Image getIconImage(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 60, 30));
    ...
    int  validacion= 0;
        ...
        try {
            ...
            "UPDATE  productos SET  producto_nombre = ?,dosis = ? ,descripcion = ?, precio = ? WHERE productos_id =?  " );
            
                     pst.setString(1,jText_nomp.getText() );
                     pst.setString(2, jText_cantidad.getText());
                     pst.setString(3, jText_des.getText());
                     pst.setString(4, jText_precio.getText());
                     pst.setString(5, jText_nump.getText());
           ...
           JOptionPane.showMessageDialog(null, "Error al modificar producto ");
            ...
            JOptionPane.showMessageDialog(null, "No hay ningun dato que modificar ");
        }
